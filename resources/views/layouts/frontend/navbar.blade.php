                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#"><i class="fa fa-heart"></i> My Wishlist
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#"><i class="fa fa-shopping-cart"></i> My
                                            Cart</a>
                                    </li>
                                    <li>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('featured_products') }}">Featured Products</a>
                    </li>
                    <li class="nav-item">
                    ...
                    @auth
                        @if (auth()->user()->role == 'admin')
                            <li class="nav-item float-right">
                                <a class="nav-link text-white rounded" href="{{ url('admin/dashboard') }}"
                                    style="background-color: #2874f0; margin: 3px;">Go to Dashbaord</a>
                            </li>
                        @endif
                    @endauth
                </ul>
